//***********program to find the symmetric difference between two linked list********************
#include<stdio.h>
#include<stdlib.h>
struct node{
	int info;
   ...
   insend(struct node **start,int x)
{
 ...
 int difference(struct node*start1,struct node*start2)
 {
...
printf("\nthe symmetric  difference between two linked list is=>");
traverse(start3);
